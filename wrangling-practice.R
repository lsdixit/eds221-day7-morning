...
# practice with lubridate within a data frame
...
# returns TRUE or FALSE depending on whether pattern is detected or not
...
# remove leading, trailing, and duplicate spaces using str_squish
str_squish(feedback)
